...
import { UserCircle, KeyRound, ShieldCheck, Smartphone, MessageSquare } from "lucide-react";
...
export default function AdminProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex">
      ...
      <div className="ml-64 flex-1 p-8 max-w-2xl space-y-8">
        <div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          ...
          <div className="space-y-3 text-sm">
            <div>
              ...
              <p className="text-slate-200">{adminName || "—"}</p>
            </div>
            <div>
              <span className="text-slate-500">Email</span>
              <p className="text-slate-200">{adminEmail || "—"}</p>
            </div>
          </div>
        </div>
