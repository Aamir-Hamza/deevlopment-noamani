...
export default function CartPage() {
  ...
  const handleQuantityChange = async (itemId: string, newQuantity: number) => {
    try {
      ...
      toast.error(t('cart.cartUpdateFailed'))
    }
  }
  ...
  const handleRemoveFromCart = async (itemId: string) => {
    try {
      ...
      toast.error(t('cart.itemRemoveFailed'))
    }
  }
      ...
      <div className="min-h-screen">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          >
            ...
            <h2 className="text-3xl font-light mb-4">{t('cart.cartEmpty')}</h2>
            <p className="text-gray-500 mb-8">{t('cart.cartEmptySubtitle')}</p>
            <Link
              href="/shop"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="bg-white rounded-lg shadow-sm p-8 sticky top-24">
              <h2 className="text-2xl font-light text-gray-900 mb-6">{t('cart.orderSummary')}</h2>
